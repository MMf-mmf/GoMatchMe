...
# THE PURPOSE OF THIS FILE IS TO CHANGE THE SESSION AUTHENTICATION TO TOKEN AUTHENTICATION FOR ALL CHAT CONSUMER FUNCTIONALITY
...
class TokenAuthentication:
    ...
    * user -- The user to which the token belongs
    ...
    def authenticate_credentials(self, key):
        ...
        key = key[1:-1]
        # breakpoint()
        # the string is double wraped in quotes remove them
        try:
